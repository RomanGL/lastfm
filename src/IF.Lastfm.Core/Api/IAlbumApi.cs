...
namespace IF.Lastfm.Core.Api
{
    public interface IAlbumApi
    {
        ...
        Task<LastResponse<LastAlbum>> GetInfoAsync(string artist, string album, bool autocorrect = false, string lang = null);

        Task<LastResponse<LastAlbum>> GetInfoByMbidAsync(string albumMbid, bool autocorrect = false, string lang = null);
